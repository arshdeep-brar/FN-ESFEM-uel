MODULE utility_module
    ...
    CONTAINS
        ...
        PURE FUNCTION Inverse4(A, det) RESULT(Ainv)
            ...
            Ainv(1,1) = (ONE / det) * (A(2,2) * (A(3,3)*A(4,4) - A(3,4)*A(4,3)) + &
                                    &  A(2,3) * (A(3,4)*A(4,2) - A(3,2)*A(4,4)) + &
                                    &  A(2,4) * (A(3,2)*A(4,3) - A(3,3)*A(4,2)))
            Ainv(2,1) = (ONE / det) * (A(2,1) * (A(3,4)*A(4,3) - A(3,3)*A(4,4)) + &
                                    &  A(2,3) * (A(3,1)*A(4,4) - A(3,4)*A(4,1)) + &
                                    &  A(2,4) * (A(3,3)*A(4,1) - A(3,1)*A(4,3)))
            Ainv(3,1) = (ONE / det) * (A(2,1) * (A(3,2)*A(4,4) - A(3,4)*A(4,2)) + &
                                    &  A(2,2) * (A(3,4)*A(4,1) - A(3,1)*A(4,4)) + &
                                    &  A(2,4) * (A(3,1)*A(4,2) - A(3,2)*A(4,1)))
            Ainv(4,1) = (ONE / det) * (A(2,1) * (A(3,3)*A(4,2) - A(3,2)*A(4,3)) + &
                                    &  A(2,2) * (A(3,1)*A(4,3) - A(3,3)*A(4,1)) + &
                                    &  A(2,3) * (A(3,2)*A(4,1) - A(3,1)*A(4,2)))

            Ainv(1,2) = (ONE / det) * (A(1,2) * (A(3,4)*A(4,3) - A(3,3)*A(4,4)) + &
                                    &  A(1,3) * (A(3,2)*A(4,4) - A(3,4)*A(4,2)) + &
                                    &  A(1,4) * (A(3,3)*A(4,2) - A(3,2)*A(4,3)))
            Ainv(2,2) = (ONE / det) * (A(1,1) * (A(3,3)*A(4,4) - A(3,4)*A(4,3)) + &
                                    &  A(1,3) * (A(3,4)*A(4,1) - A(3,1)*A(4,4)) + &
                                    &  A(1,4) * (A(3,1)*A(4,3) - A(3,3)*A(4,1)))
            Ainv(3,2) = (ONE / det) * (A(1,1) * (A(3,4)*A(4,2) - A(3,2)*A(4,4)) + &
                                    &  A(1,2) * (A(3,1)*A(4,4) - A(3,4)*A(4,1)) + &
                                    &  A(1,4) * (A(3,2)*A(4,1) - A(3,1)*A(4,2)))
            Ainv(4,2) = (ONE / det) * (A(1,1) * (A(3,2)*A(4,3) - A(3,3)*A(4,2)) + &
                                    &  A(1,2) * (A(3,3)*A(4,1) - A(3,1)*A(4,3)) + &
                                    &  A(1,3) * (A(3,1)*A(4,2) - A(3,2)*A(4,1)))

            Ainv(1,3) = (ONE / det) * (A(1,2) * (A(2,3)*A(4,4) - A(2,4)*A(4,3)) + &
                                    &  A(1,3) * (A(2,4)*A(4,2) - A(2,2)*A(4,4)) + &
                                    &  A(1,4) * (A(2,2)*A(4,3) - A(2,2)*A(4,2)))
            Ainv(2,3) = (ONE / det) * (A(1,1) * (A(2,4)*A(4,3) - A(2,3)*A(4,4)) + &
                                    &  A(1,3) * (A(2,1)*A(4,4) - A(2,4)*A(4,1)) + &
                                    &  A(1,4) * (A(2,3)*A(4,1) - A(2,1)*A(4,3)))
            Ainv(3,3) = (ONE / det) * (A(1,1) * (A(2,2)*A(4,4) - A(2,4)*A(4,2)) + &
                                    &  A(1,2) * (A(2,4)*A(4,1) - A(2,1)*A(4,4)) + &
                                    &  A(1,4) * (A(2,1)*A(4,2) - A(2,2)*A(4,1)))
            Ainv(4,3) = (ONE / det) * (A(1,1) * (A(2,3)*A(4,2) - A(2,2)*A(4,3)) + &
                                    &  A(1,2) * (A(2,1)*A(4,3) - A(2,3)*A(4,1)) + &
                                    &  A(1,3) * (A(2,2)*A(4,1) - A(2,1)*A(4,2)))
                                    
            Ainv(1,4) = (ONE / det) * (A(1,2) * (A(2,4)*A(3,3) - A(2,3)*A(3,4)) + &
                                    &  A(1,3) * (A(2,2)*A(3,4) - A(2,4)*A(3,2)) + &
                                    &  A(1,4) * (A(2,3)*A(3,2) - A(2,2)*A(3,3)))
            Ainv(2,4) = (ONE / det) * (A(1,1) * (A(2,3)*A(3,4) - A(2,4)*A(3,3)) + &
                                    &  A(1,3) * (A(2,4)*A(3,1) - A(2,1)*A(3,4)) + &
                                    &  A(1,4) * (A(2,1)*A(3,3) - A(2,3)*A(3,1)))
            Ainv(3,4) = (ONE / det) * (A(1,1) * (A(2,4)*A(3,2) - A(2,2)*A(3,4)) + &
                                    &  A(1,2) * (A(2,1)*A(3,4) - A(2,4)*A(3,1)) + &
                                    &  A(1,4) * (A(2,2)*A(3,1) - A(2,1)*A(3,2)))
            Ainv(4,4) = (ONE / det) * (A(1,1) * (A(2,2)*A(3,3) - A(2,3)*A(3,2)) + &
